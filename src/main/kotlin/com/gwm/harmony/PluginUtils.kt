package com.gwm.plugin.data.ui
 ...
 */
fun Any.jLabel(text: String,mouseDraggedListener: () -> Unit, textSize: Float = 13f, init: JLabel.() -> Unit = {}): JLabel {
    val jLabel = JLabel(text).apply {
        font = font.deriveFont(textSize)
    }
    jLabel.addMouseMotionListener(object :MouseMotionListener{
...
fun Any.jColorChooser(
    changeListener: () -> Unit = {},
    init: JColorChooser.() -> Unit = {}):JColorChooser{
    val jColorChooser = JColorChooser()
    jColorChooser.selectionModel.addChangeListener{
        changeListener.invoke()
    }
    jColorChooser.init()
    checkAddView(this, jColorChooser)
